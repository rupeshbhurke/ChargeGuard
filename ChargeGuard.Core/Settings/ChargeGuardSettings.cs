namespace ChargeGuard.Core.Settings;
...
public class ChargeGuardSettings
{
    ...
    /// <summary>
    /// Gets or sets whether the application starts with the operating system.
    /// Platform-specific implementation handles the actual startup registration.
    /// </summary>
